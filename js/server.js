...
// const url =
//   "mongodb+srv://pilot:tIiRozJfYqT6iZPc@cluster0.gjfxw1c.mongodb.net/IT-LIVE?retryWrites=true&w=majority";
...
mongoose.connect("mongodb+srv://pilot:tIiRozJfYqT6iZPc@cluster0.gjfxw1c.mongodb.net/?retryWrites=true&w=majority", {
...
app.post("/submit", async (req, res) => {
  const { fullname, email, number, work } = req.body;

  try {
    // Create new contact document and save to database
    const contact = new Contact({ fullname, email, number, work });
    await contact.save();
